                    ...
                    <table border="0px" class="hmstar_header_box_login_form_table">
                        ...
                        <div class="hmstar_header_box_login_form_div">
                            <div class="hmstar_header_box_login_form_div_top">
                                ...
                                <input type="button" class="hmstar_header_box_form_gettelcode" id="hmstar_header_box_register_yzm_btn" data-toggle="modal" data-backdrop="static" onclick="hmstar_common_showMobileSend();" value="获取验证码" />
                            </div>
                            <p class="clear-both"></p>
