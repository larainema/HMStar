     ...
     <div class="hmstar-footer-list">
          <div class="hmstar-footer-list-t">
               <ul class="hmstar-footer-ul">
                    ...
                    <li>
                         <h4 class="h4-img2">帮助中心</h4>
                         <a target="_blank" href="">新手必读</a>
                    </li>
               </ul>
               <div class="hmstar-footer-weixin">
          ...
          <div class="hmstar-footer-list-c">
               <div class="hmstar-copyright">
                    <p>版权所有 © 北京黑马之星科技有限公司 www.heimaxing.com</p>
                    <p>Copyright Beijing Heimaxing Technology Co.,Ltd</p>
                    <p> </p>
               </div>
          </div>
          <div class="hmstar-footer-list-b">
               <span>友情链接 <a></a></span>
          </div>
    </div>
</div>
